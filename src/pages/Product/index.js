    ...
    return (
        <div className="p-4">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-medium text-sky-700 my-4">Products</h1>
            ...
            <div className="flex justify-between px-6 bg-gray-500 text-white font-semibold rounded-sm">
                <div>
                    <h1>Name</h1>
                </div>
                <div>
